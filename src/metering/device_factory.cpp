...
template<typename T>
std::shared_ptr<IEagle> DeviceFactory::CreateDevice()
{
...
template<>
std::shared_ptr<IEagle> DeviceFactory::CreateDevice<Eagle200>()
{
...
template<>
std::shared_ptr<IEagle> DeviceFactory::CreateDevice<RFA_Z109>()
{
