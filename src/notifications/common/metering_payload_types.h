...
struct streamable_any : public std::any
{
	...
	template<>
	explicit streamable_any(uint8_t&& t) : std::any(uint8_t(t)), streamer([](std::ostream& os, streamable_any const& self)
		{
	...
	template<>
	explicit streamable_any(std::chrono::time_point<std::chrono::system_clock>&& t) : std::any(std::chrono::time_point<std::chrono::system_clock>(t)), streamer([](std::ostream& os, streamable_any const& self)
		{
