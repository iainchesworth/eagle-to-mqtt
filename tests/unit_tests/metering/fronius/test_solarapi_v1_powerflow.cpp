...
BOOST_AUTO_TEST_CASE(Test_PowerFlow, *boost::unit_test::tolerance(0.00001)) // Tolerance is for energy prodction testing (floating-point)
{
    ...
    try
    {
        ...
        BOOST_TEST(sacdpf_hybrid.Inverters().at(1).Id() == 1);
        BOOST_TEST(sacdpf_hybrid.Inverters().at(1).DeviceType().has_value());
        BOOST_TEST(sacdpf_hybrid.Inverters().at(1).DeviceType().value() == 99);
        ...
        BOOST_TEST(sacdpf_nonhybrid.Inverters().at(1).Id() == 1);
        BOOST_TEST(sacdpf_nonhybrid.Inverters().at(1).DeviceType().has_value());
        BOOST_TEST(sacdpf_nonhybrid.Inverters().at(1).DeviceType().value() == 102);
        ...
        BOOST_TEST(!sacdpf_nonhybrid.Inverters().at(1).ComponentId().has_value());
        ...
        BOOST_TEST(sacdpf_nonhybrid.Inverters().at(2).Id() == 2);
        BOOST_TEST(sacdpf_nonhybrid.Inverters().at(2).DeviceType().has_value());
        BOOST_TEST(sacdpf_nonhybrid.Inverters().at(2).DeviceType().value() == 86);
        ...
        BOOST_TEST(!sacdpf_nonhybrid.Inverters().at(2).ComponentId().has_value());
        ...
        BOOST_TEST(sacdpf_nonhybrid.Inverters().at(3).Id() == 3);
        BOOST_TEST(sacdpf_nonhybrid.Inverters().at(3).DeviceType().has_value());
        BOOST_TEST(sacdpf_nonhybrid.Inverters().at(3).DeviceType().value() == 106);
        ...
        BOOST_TEST(!sacdpf_nonhybrid.Inverters().at(3).ComponentId().has_value());
        ...
        BOOST_TEST(sacdpf_nonhybrid.Inverters().at(55).Id() == 55);
        BOOST_TEST(sacdpf_nonhybrid.Inverters().at(55).DeviceType().has_value());
        BOOST_TEST(sacdpf_nonhybrid.Inverters().at(55).DeviceType().value() == 224);
        ...
        BOOST_TEST(!sacdpf_nonhybrid.Inverters().at(55).ComponentId().has_value());
        ...
        BOOST_TEST(sacdpf_gen24.Inverters().at(1).Id() == 1);
        BOOST_TEST(sacdpf_gen24.Inverters().at(1).DeviceType().has_value());
        BOOST_TEST(sacdpf_gen24.Inverters().at(1).DeviceType().value() == 1);
